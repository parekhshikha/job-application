...
<div id="body">
  <div class="blog1">
	...
	$qur1=mysql_query("select * from job_detail limit $stops,$pgsize");
	...
	while($q=mysql_fetch_row($qur1))
	{
		...
		echo "<td>$q[5]</td>";
		echo "<td>$q[6]</td>";
		echo "<td><a href='admin_view_apply.php?jid=$q[0]'>VIEW APPLIED DETAIL</a></td>";
		echo "</tr>";
	}
	echo "</table>";
