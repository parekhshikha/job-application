...
if(isset($_POST['btnregis']))
{
	...
	if(mysql_num_rows($res)>0)
	{
		...
		mysql_query("insert into user_regis(`full_name`,`address`,`city`,`state`,`mob_no`,`email_id`,`pwd`,`regis_date`)values('$name','$add','$city','$state','$mno','$email','$pwd','$date1')") or die("Registration Failed");
		$message="Registered";
		echo"<script type='text/javascript'>";
		echo "alert('$message');";
